...
% --- Executes on button press in optimal_map_pushbutton.
function optimal_map_pushbutton_Callback(hObject, eventdata, handles)
% hObject    handle to optimize_pushbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Get the last plot pushbutton used
...
% Execute the gait_gui_optimize command
gait_gui_optimal_map(plot_info(1).axes(1),hObject, eventdata, handles);
waitbar2a(1,handles.main_gui.progresspanel,'Finished Plotting')
