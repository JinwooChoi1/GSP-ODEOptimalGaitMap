function gait_gui_optimal_map(hAx,hObject,eventdata,handles)
...
%%%%% Call the optimizer
y = optimalmapgenerator(s,n_dim,n_plot,alpha_plot,lb,ub,stretch,direction,costfunction,handles);
